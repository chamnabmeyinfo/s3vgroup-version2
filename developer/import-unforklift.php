...
<div class="max-w-7xl mx-auto">
    <!-- Header -->
    <div class="bg-gradient-to-r from-teal-600 to-cyan-600 rounded-xl shadow-xl p-8 mb-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-teal-100 text-lg">Import products from UN Forklift website to your database</p>
            </div>
            <div class="bg-white/20 rounded-full px-6 py-3 backdrop-blur-sm">
                <div class="flex items-center space-x-2">
                    <i class="fas fa-external-link-alt"></i>
                    <span class="font-semibold">unforklift.com</span>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <tbody>
                                    <?php foreach ($importResults as $result): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($result['status'] === 'success'): ?>
                                                    <a href="<?= url('admin/product-edit.php?id=' . $result['id']) ?>" class="btn btn-sm btn-outline-primary">
                                                        View/Edit
                                                    </a>
                                                <?php else: ?>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <ol>
                        ...
                        <li>Use the <a href="<?= url('admin/product-edit.php') ?>">Add Product</a> page to manually create products</li>
                    </ol>
                    <p class="text-muted">
