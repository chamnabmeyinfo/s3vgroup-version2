    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-xl p-4 md:p-6 lg:p-8 mb-4 md:mb-6 text-white">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div class="flex gap-3">
                <a href="<?= url('admin/hero-slider-settings.php') ?>" class="bg-white/20 text-white px-4 md:px-6 py-2 md:py-3 rounded-lg font-bold hover:bg-white/30 transition-all shadow-lg hover:shadow-xl">
